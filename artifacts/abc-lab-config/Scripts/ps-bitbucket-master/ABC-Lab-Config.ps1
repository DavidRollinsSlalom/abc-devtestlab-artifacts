...
$msgBoxInput =  [System.Windows.MessageBox]::Show('Would you like to configure the lab for Java?','Platform Select','YesNo','Error')
switch  ($msgBoxInput) {
...
'No' {
    $msgBoxInput =  [System.Windows.MessageBox]::Show('Would you like to configure the lab for .Net Core?','Platform Select','YesNo','Error')
    switch  ($msgBoxInput) {
        'Yes'{
            Set-BitBucketServer -Url "https://api.bitbucket.org"
            $BitBucketCred = Get-Credential -Message "Please enter the username and password for your BitBucket Account provided by the lab instructor."
